...
import csv
from conversation_initializer import conversation_initializer
...
def make_response(user_input):
	...
	resp = conversation_initializer(user_input)
	# resp = {
	...
	# }
	# resp = {'url': '/lime_plots/LIME_WHY_RECORD_11.png', 'intention': 'wants_plot', 'end_of_conversation': False}
	print(f'\n\nresp --> {resp}')
...
def make_response_old(user_input):
	...
	elif intention == 'end_of_conversation':
		return {
